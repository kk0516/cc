...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>员工性别：</td>
								<td><input type="radio" id="gender" name="gender" value="女" aria-required="true" required/>女
								<input type="radio" id="gender" name="gender" value="男" aria-required="true" required/>男
	...
	function initEditUser(getSelection){
		...
		$('#gender').val(getSelection.gender);
