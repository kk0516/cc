...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="kId" id = "txt_search_roleid">
					...
					<form id="form_user" method="post" action="reserveExpress.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>快递时间：</td>
								<td><input type="date" id="eCreatetime" name="eCreatetime"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>注册资金</td>
								<td><input type="text" id="eZhi" name="eZhi"
									class="form-control" aria-required="true" required/></td>
								<td>快递地址：</td>
								<td colspan="4">
	...
	function initEditUser(getSelection){
		...
		$('#eCreatetime').val(new Date(getSelection.eCreatetime).Format("yyyy-MM-dd"));
		$('#eZhi').val(getSelection.eZhi);
		$('#kId').val(getSelection.kId);
	}
