...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveDevice.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>设备名称：</td>
								<td><input type="text" id="devicename" name="devicename" class="form-control" aria-required="true" required/></td>
								<td>设备内存：</td>
								<td><input type="text" id="deviceram" name="deviceram" class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>机身颜色：</td>
								<td><input type="text" id="color" name="color" class="form-control" aria-required="true" required/></td>
								<td>费用：</td>
								<td><input type="text" id="price" name="price" class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>状态：</td>
								<td colspan="4">
	...
	$("#export_user_btn").click(function(){
		//往后端发送请求
		location.href="exportDevice.htm";	
	$('#modal_user_del').modal('hide');   		
	});
	</script>
