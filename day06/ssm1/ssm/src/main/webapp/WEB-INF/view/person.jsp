...
<body class="gray-bg">
       ...
       <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="id" id = "txt_search_roleid">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>人员名字：</td>
								<td><input type="text" id="expressName" name="expressName"class="form-control" aria-required="true" required/></td>

								<td>人员性别</td>
								<td><input type="radio" id="sex" name="sex"value="男" aria-required="true" required/>男
								<input type="radio" id="sex" name="sex"value="女" aria-required="true" required/>女</td>
							</tr>
							<tr>
								...
								<td>员工特点：</td>
								<td>
									<input type="checkbox" id="expressTrait1" name="expressTrait"  aria-required="true" required value="好"/>好
									<input type="checkbox" id="expressTrait2" name="expressTrait"  aria-required="true" required value="非常好"/>非常好
	...
	function initEditUser(getSelection){
		...
		$("#expressTrait1").prop("checked",getSelection.expressTrait.indexOf("好")!=-1);
		$("#expressTrait2").prop("checked",getSelection.expressTrait.indexOf("非常好")!=-1);
