...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">学校姓名</span>
					<select class="form-control" name="sid" id = "txt_search_roleid">
			 ...
			 <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="satrt" class="form-control" id="start" >
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生生日：</td>
								<td><input type="date" id="birthday" name="birthday"class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>年龄：</td>
							...
							<tr>
								<td>学校名称：</td>
								<td colspan="4">
									<select class="form-control" name="sid" id = "sid" aria-required="true" required>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<form id="StudentId" action="importStudent.htm" method="post" enctype="multipart/form-data">
							<input type="file" name="studentXls" id="studentXls">
						</form>
				</div>
				<div class="modal-footer">
	...
	$(function () {
	  ...
	  //导入
    var validator = $("#StudentId").validate({
		submitHandler: function(form){
		      $(form).ajaxSubmit({
		    	dataType:"json",
		    	success: function (data) {
	...
	$("#export_user_btn").click(function(){
		//往后端发送请求
		location.href="exportStudent.htm";	
	$('#modal_user_del').modal('hide');   		
	});
	</script>
