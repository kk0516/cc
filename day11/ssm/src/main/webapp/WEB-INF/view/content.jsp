...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>广告标题：</td>
								<td><input type="text" id="contenttitle" name="contenttitle"/></td>
								<td>&nbsp;&nbsp;</td>
								<td>费用：</td>
							...
							<tr>
								<td>图片路径：</td>
								<td><input type="text" id="contenturl" name="contenturl"/></td>
								<td>&nbsp;&nbsp;</td>
								<td>广告链接：</td>
							...
							<tr>
								<td>广告分类：</td>
								<td colspan="4">
									<select class="form-control" name="contentcategoryid" id = "roleid" aria-required="true" required>
							...
							<tr>
								...
								<td>创建时间：</td>
								<td><input type="date" id="bid" name="createtime"/></td>
							</tr>
						</table>
	...
	function initEditUser(getSelection){
		...
		$('#roleid').val(getSelection.contentcategoryid);
		...
		$('#bid').val(new Date(getSelection.createtime).Format("yyyy-MM-dd"));
