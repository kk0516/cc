...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			 ...
			 <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">时间区间查 </span>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmp.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td><input type="text" id="eName" name="eName"class="form-control" aria-required="true" required/></td>
							...
							<tr>
								<td>学生性别：</td>
								<td><input type="radio" id="gender" name="gender" value="男" aria-required="true" required/>男
								<input type="radio" id="gender" name="gender" value="女" aria-required="true" required/>女</td>
								<td>学生年龄：</td>
								<td><input type="test" id="age" name="age"class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>学生头像</td>
								<td>
									<img src="" id="pic" width="30px" hegit="30px">
									<input type="file" id="picFile" name="picFile" aria-required="true" required/>
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                title: '学生头像',
	                formatter:function(value,row,index){
	                	return '<img src="/photo/'+value+'" width="30px" height="30px"/>';
